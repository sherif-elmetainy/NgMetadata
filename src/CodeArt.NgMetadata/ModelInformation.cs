...
namespace CodeArt.NgMetadata
{
    ...
    public abstract class ModelInformation
    {
	    ...
	    /// <summary>
	    /// Property name which can be the same as <see cref="Key"/> or different depending on <see cref="NgMetadataOptions.ModelSerializerSettings" /> and whether it has <see cref="JsonPropertyAttribute"/>.
	    /// </summary>
